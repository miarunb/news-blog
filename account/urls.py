...
from account.views import RegistrationView, ChangePasswordView
...
urlpatterns = [
    ...
    path('forgot_pass_complete/', TemplateView.as_view(template_name='account/...'), name='forgot-pass-complete')
]